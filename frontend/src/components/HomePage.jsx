...
const translations = {
  en: {
    ...
    feature2_desc: "94% accuracy validated by medical professionals.",
  ...
  hi: {
    ...
    feature2_desc: "94% सटीकता, चिकित्सकों द्वारा सत्यापित।",
  ...
  mr: {
    ...
    feature2_desc: "94% अचूकता, वैद्यकीय तज्ञांनी प्रमाणित।",
  ...
  kn: {
    ...
    feature2_desc: "94% ನಿಖರತೆ, ವೈದ್ಯರಿಂದ ಪರಿಶೀಲಿಸಲಾಗಿದೆ.",
    ...
    <div className="space-y-4 animate-fadeIn">
      ...
      <footer className={`text-center py-6 text-xs ${mutedText} border-t ${dark ? "border-slate-800" : "border-slate-200"}`}>
        ...
        <p className="mt-2 font-medium">
          Created with <span className="text-red-500">♥</span> by Adhya Jain
        </p>
      </footer>
